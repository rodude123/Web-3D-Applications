...
document.querySelector("#contactPg").addEventListener("click", () =>
{
    swapPages(`#${document.querySelector(".showPg").id}`, "#contact");
});

document.querySelector("#deeperUnderstandingPg").addEventListener("click", () =>
{
    swapPages(`#${document.querySelector(".showPg").id}`, "#deeperUnderstanding");
});
